...
public interface ICommonDialog extends Com4jObject {
   ...
   * </p>
   * @param device Mandatory com.wia.IDevice parameter.
  ...
  @VTID(8)
  com.wia.IImageFile showAcquireImage(
    @Optional @DefaultValue("0") com.wia.WiaDeviceType deviceType,
    @Optional @DefaultValue("0") com.wia.WiaImageIntent intent,
    @Optional @DefaultValue("131072") com.wia.WiaImageBias bias,
  ...
  @VTID(9)
  com.wia.IDevice showSelectDevice(
    @Optional @DefaultValue("0") com.wia.WiaDeviceType deviceType,
    @Optional @DefaultValue("0") boolean alwaysSelectDevice,
    @Optional @DefaultValue("0") boolean cancelError);
  ...
  @VTID(10)
  com.wia.IItems showSelectItems(
    com.wia.IDevice device,
    @Optional @DefaultValue("0") com.wia.WiaImageIntent intent,
    @Optional @DefaultValue("131072") com.wia.WiaImageBias bias,
   ...
   * </p>
   * @param item Mandatory com.wia.IItem parameter.
   * @param cancelError Optional parameter. Default value is false
   */
