...
public interface IDeviceManager extends Com4jObject {
   ...
   * </p>
   * @return  Returns a value of type com.wia.IDeviceInfos
   */

  @DISPID(1) //= 0x1. The runtime will prefer the VTID if present
  @VTID(7)
  com.wia.IDeviceInfos deviceInfos();


  @VTID(7)
  @ReturnValue(defaultPropertyThrough={com.wia.IDeviceInfos.class})
  com.wia.IDeviceInfo deviceInfos(
